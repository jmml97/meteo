...
struct AEMETHourlyPredictionRoot: Codable {
...
// MARK: - AEMETDailyPredictionRoot
struct AEMETDailyPredictionRoot: Codable {
    let created, name, province: String
...
enum AEMETSkyDescription: String, Codable {
    ...
    case cubiertoLluvia = "Cubierto con lluvia"
    case cubiertoTormentaLluviaEscasa = "Cubierto con tormenta y lluvia escasa"
    ...
    case intervalosNubososTormentaLluviaEscasa = "Intervalos nubosos con tormenta y lluvia escasa"
    case nuboso = "Nuboso"
